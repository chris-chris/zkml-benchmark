...
for i in {1..5}; do
    ...
    run_benchmark "ezkl" $i "ezkl prove --witness models/mlp22/mlp$i/witness.json --pk-path models/mlp22/mlp$i/pk.key --compiled-circuit models/mlp22/mlp$i/model.compiled --proof-path models/mlp22/mlp$i/proof.json"
